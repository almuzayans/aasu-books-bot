...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    await update.message.reply_text(
        ...
        "بوت غير رسمي يساعد طلاب الجامعات في الكويت على الوصول إلى الكتب والمراجع الإنجليزية.\n\n"
        "1️⃣ اختر القسم من الأزرار في الأسفل.\n"
        "2️⃣ اختر اسم الكتاب ليصلك ملف الـ PDF.\n\n"
        f"إذا لم تجد كتابك اضغط «{REQUEST_BUTTON}» أو زر قناتنا 📣 @universitiesbooks لطلب الكتب غير الموجودة.",
